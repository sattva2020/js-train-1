...
function isPositiveNumber(num) {
  if (num > 0) {
 return false; // Перевіряємо, чи число num більше 0
 }
...
function getVariableType(variable) {
  ...
  const message = variableType === "number"
...
function memoizedArea() {
  let prevSide = null; // Ініціалізуємо примітивні змінні для зберігання попереднього аргументу та результату
  let prevResult = null;
